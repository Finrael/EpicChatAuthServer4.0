...
router.post('/addUserExtraInfo', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var comDataUser, contactToLookFor, filter, creationDate, complementaryData, updateUser, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, userSchema_1.default.update(filter, complementaryData)];
            case 2:
                updateUser = _a.sent();
